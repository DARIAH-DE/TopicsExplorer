...
This module provides functions to generate visualizations for a LDA model and
has been imported from the `DARIAH-DE`_ project.

Todo: create figure dynamically?
...
__authors__ = "Stefan Pernes, Sina Bock, Severin Simmler"
__email__ = "stefan.pernes@uni-wuerzburg.de, sina.bock@stud-mail.uni-wuerzburg.de, severin.simmler@stud-mail.uni-wuerzburg.de"
__version__ = "0.3"
__date__ = "2016-10-10"
