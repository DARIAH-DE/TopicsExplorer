...
def create_sparse_bow(doc_labels, doc_tokens, type_dictionary, doc_ids):
...
def make_doc2bow_list(sparse_bow):
    ...
    Description:
        ...
        function `get_document_topics()` to show the keywords for each topic.

    Args:
        sparse_bow (DataFrame):
